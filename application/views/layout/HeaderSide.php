                                        ...
                                        <li>
                                            <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                                <li>
                                                    <a href="#">
                                                                <span class="photo">
                                                                    <img src="<?php echo base_url();?>application/assets/layouts/layout3/img/avatar2.jpg" class="img-circle" alt=""> </span>
                                                        <span class="subject">
                                                ...
                                                <li>
                                                    <a href="#">
                                                                <span class="photo">
                                                                    <img src="<?php echo base_url();?>application/assets/layouts/layout3/img/avatar3.jpg" class="img-circle" alt=""> </span>
                                                        <span class="subject">
                                                ...
                                                <li>
                                                    <a href="#">
                                                                <span class="photo">
                                                                    <img src="<?php echo base_url();?>application/assets/layouts/layout3/img/avatar1.jpg" class="img-circle" alt=""> </span>
                                                        <span class="subject">
                            ...
                            <ul class="nav navbar-nav">
                                <li class="menu-dropdown classic-menu-dropdown ">
                                    ...
                                    <ul class="dropdown-menu pull-left">
                                        <li class=" active">
                                            <a href="<?php echo base_url();?>DirektoratPKK/PencariKerjaTerdaftar" class="nav-link  active">
                                                <i class="icon-bar-chart"></i> Pencari Kerja Terdaftar
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="<?php echo base_url();?>DirektoratPKK/LowonganKerjaTerdaftar" class="nav-link  ">
